...
tophat2 --library-type fr-secondstrand --read-mismatches=5 --read-edit-dist=5 -o tophat_output/IonXpress_RNA_046 -p 16 --transcriptome-index=reference-sequences/transcriptome_data/GRCm38 reference-sequences/GRCm38 raw_sequences/IonXpress_RNA_046.R_2015_07_09_15_35_39_user_SER-152-DBridges_39RNAseq_sample_project_pool_7_7-8-15.fastq
bam2fastx -q -Q -A -o tophat_output/IonXpress_RNA_046/unmapped.fastq tophat_output/IonXpress_RNA_046/unmapped.bam
bowtie2 -p 16 --very-sensitive-local -x -mm -x reference-sequences/GRCm38 -U tophat_output/IonXpress_RNA_046/unmapped.fastq -S tophat_output/IonXpress_RNA_046/remapped.sam
samtools view -bS tophat_output/IonXpress_RNA_046/remapped.sam > tophat_output/IonXpress_RNA_046/remapped.bam
