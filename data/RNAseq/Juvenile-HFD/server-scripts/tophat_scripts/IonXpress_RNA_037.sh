...
tophat2 --library-type fr-secondstrand --read-mismatches=5 --read-edit-dist=5 -o tophat_output/IonXpress_RNA_037 -p 16 --transcriptome-index=reference-sequences/transcriptome_data/GRCm38 reference-sequences/GRCm38 raw_sequences/IonXpress_RNA_037.R_2015_07_07_17_21_32_user_SER-148-DBridges_39RNAseq_project_pool_4_7-2-15.fastq
bam2fastx -q -Q -A -o tophat_output/IonXpress_RNA_037/unmapped.fastq tophat_output/IonXpress_RNA_037/unmapped.bam
bowtie2 -p 16 --very-sensitive-local -x -mm -x reference-sequences/GRCm38 -U tophat_output/IonXpress_RNA_037/unmapped.fastq -S tophat_output/IonXpress_RNA_037/remapped.sam
samtools view -bS tophat_output/IonXpress_RNA_037/remapped.sam > tophat_output/IonXpress_RNA_037/remapped.bam
