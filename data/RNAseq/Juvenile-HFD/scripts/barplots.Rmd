...
#list of genes from the Gillbert et al. paper
Gillbert_gene <- c("Elovl6", "Fads2", "Nnat", "Insr", "Irs2", "Slc27a2", "Cdk5", "Igfbp5", "Slc2a4")
...
gillbert_dat <- get_goi_data(rpkm.data.unique, Gillbert_gene)
gillbert.long.wat <- get_long_format(gillbert_dat)
...
gillbert.dat.quad <- get_goi_data(rpkm.data.unique.quad, Gillbert_gene)
gillbert.long.quad <- get_long_format(gillbert.dat.quad)
...
draw_barplot(gillbert.long.wat, gillbert.long.quad , Gillbert_gene)
```
