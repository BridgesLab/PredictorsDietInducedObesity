...
library(stargazer)
stargazer(wat.counts, type="text", title="Descriptive statistics", digits=1, out="results/WAT_Descriptive_stats.txt")
stargazer(quad.counts, type="text", title="Descriptive statistics", digits=1, out="results/QUAD_Descriptive_Stats.txt")
```
# Adipose Tissue
...
rld.quad <- rlog(dds.quad.feeding)
plotPCA(rld.quad, intgroup=c("Feeding","Diet"))
distsRL <- dist(t(assay(rld.quad)))
