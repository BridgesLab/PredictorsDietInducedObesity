...
#remove any duration that is more than 500
cohort7 <- cohort7[cohort7$Duration<500,]
...
boxplot(Weight~Light_Dark, data=cohort7)
boxplot(Duration~Light_Dark, data=cohort7)
wilcox.test(Weight ~ Light_Dark, data=cohort7, alternative="greater")
...
There is no difference in the food intake across all animals in each dark and light cycle. The p-value `r wilcox.test(Weight ~ Light_Dark, data=cohort7, alternative="greater")$p.value`
