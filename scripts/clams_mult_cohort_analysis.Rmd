...
ggplot(m_data_dark, aes(x=Fast, y=VO2.LBM, fill=Fast)) +
  geom_boxplot() + geom_jitter()+
...
ggplot(m_data_dark, aes(x=Fast, y=RER, fill=Fast)) +
  geom_boxplot() + geom_jitter()+
...
ggplot(m_data_dark, aes(x=Fast, y=SumXYAmb, fill=Fast)) +
  geom_boxplot() + geom_jitter()+
...
mult.corrplot(m_data_light, "VO2.LBM", "Percent.WG", "Fast", "VO2.LBM vs Percent.WG (Light)", 9, 75, 5)
ggsave("figure/VO2.LBM_vs_PercentWG_Light.pdf")

mult.corrplot(m_data_dark, "VO2.LBM", "Percent.WG", "Fast", "VO2.LBM vs Percent.WG (Dark)", 9, 50, 5)
ggsave("figure/VO2.LBM_vs_PercentWG_Dark.pdf")

mult.corrplot(m_data_light, "RER", "Percent.WG", "Fast", "RER vs Percent.WG (Light)", 1.2, 100, 5)
ggsave("figure/RER_vs_PercentWG_Light.pdf")

mult.corrplot(m_data_dark, "RER", "Percent.WG", "Fast", "RER vs Percent.WG (Dark)", 0.55, 100, 5)
ggsave("figure/RER_vs_PercentWG_Dark.pdf")

mult.corrplot(m_data_light, "SumXYAmb", "Percent.WG", "Fast", "Ambulatory vs Percent.WG (Light)", 3000, 100, 5)
ggsave("figure/Ambulatory_vs_PercentWG_Light.pdf")

mult.corrplot(m_data_dark, "SumXYAmb", "Percent.WG", "Fast", "Ambulatory vs Percent.WG (Dark)", 4000, 100, 5)
