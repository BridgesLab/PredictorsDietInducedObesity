...
write.csv(cohort9_clams, file="../data/processed/cohort8_Oxymax.csv")
```
...
write.csv(cohort9_weight, file="../data/processed/body_composition_testing_data.csv")
...
write.csv(cohort9_m_data, file='../data/processed/cohort8_longitudinal_data_for_modelling.csv')
...
write.csv(cohort9_model_data, file="../data/processed/cohort8_testing_data_for_modelling.csv")
